...
`}const h={captionsData:"alt",captionDelay:250};let y=new m(".gallery-link",h);function l(t){const n=t.hits.map(r=>p(r)).join("");s.imgEl.innerHTML=n,y.refresh()}
